...
const themeColors: Record<
  ThemeColor,
  { bg: string; textDark: string; textMid: string }
> = {
  purple: {
    bg: "bg-purple-light",
    textDark: "text-purple-dark",
    textMid: "text-neutral-dark",
  },
  sand: {
    bg: "bg-sand-light",
    textDark: "text-neutral-dark",
    textMid: "text-neutral-dark",
  },
  mist: {
    bg: "bg-mist-light",
...
export default function Hero({
  ...
  return (
    <div
      className={`${bg} w-screen -mx-[calc((100vw-100%)/2)] overflow-hidden flex flex-col sm:flex-row sm:items-center sm:min-h-[420px] lg:min-h-[523px]`}
    >
