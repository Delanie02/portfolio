...
export const metadata = {
  ...
  description:
    "Shaping a future-state product vision for FiscalNote to bring more coherence to a complex B2B policy intelligence platform.",
};
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <section id="challenge" className="py-6 md:py-12 lg:py-12 max-w-[580px] mx-auto">
          ...
          <div className="body-base text-neutral-dark space-y-4">
            <p>
              FiscalNote, a B2B SaaS policy intelligence platform, had grown through acquisition,
              resulting in four separate products serving overlapping customer needs. While each
              product provided value independently, the portfolio created increasing challenges for
              both customers and the business, such as:
            </p>
            ...
            <p>
              As a UX Manager, I saw an opportunity to help leadership answer a larger strategic
              question: How might we unify the experience across multiple products while preserving
              the value customers relied on today?
            </p>
          </div>
        </section>
        ...
        <section id="approach" className="py-6 md:py-12 lg:py-12 max-w-[580px] mx-auto">
          <h2 className="h3-bold text-purple-dark mb-6 md:mb-6 lg:mb-6">Approach</h2>
          <div className="space-y-4">
            <p className="body-base text-neutral-dark">
              To envision a unified future-state, I led a cross-functional team of product managers,
              engineers, and designers through the design process.
            </p>
          </div>
        </section>
        ...
        <div className="space-y-8 md:space-y-12 lg:space-y-12 pb-24 max-w-[980px] mx-auto">
          ...
          <div className="block sm:hidden">
            {[
              {
                title: "Discover",
                text: "I challenged existing assumptions about user needs by journey mapping users' jobs, pain points, tools, and collaborators with 30 users.",
              },
              {
                title: "Define",
                text: "I partnered with data science to create a dashboard of NLP findings. Using these findings as inputs, I co-created service blueprints and value proposition canvases with product, engineering, sales, and design.",
              },
              {
                title: "Develop",
                text: "Based on these learnings, I led a design sprint with product, design, and engineering to generate a prototype of the unified experience.",
              },
              {
                title: "Deliver",
                text: "I tested the prototype with users, which I used along with product, design, and engineering feedback to refine the prototype into a final concept.",
              },
            ].map((item, index, arr) => (
              <div key={item.title}>
                <div className="py-6">
          ...
          <div className="hidden sm:block md:hidden lg:hidden">
            <Image
              src="/images/fiscalnote/double-diamond-vertical.png"
              alt="Process diagram"
              width={600}
              height={400}
            />
          ...
          <div className="hidden md:block">
            <Image
              src="/images/fiscalnote/double-diamond-horizontal.png"
              alt="Process diagram"
              width={1200}
              height={600}
            />
        ...
        <section className="py-6 md:py-12 lg:py-12 max-w-[580px] mx-auto">
          <h3 className="h4-bold text-purple-dark mb-6">Driving organizational alignment</h3>
          <div className="space-y-4 body-base text-neutral-dark">
            <p>
              After pitching our final unified concept to the C-Suite, we needed to socialize the
              concept. Each product had dedicated customers, product teams, and business
              stakeholders. Any proposal to unify the portfolio would require balancing competing
              priorities, preserving critical workflows, and navigating organizational resistance to
              change. Success depended as much on building alignment as it did on designing the
              solution itself.
            </p>
            <p>
              To drive this alignment around our concept and help connect different teams to the
              underlying user needs, I created a series of short comics and had a designer on my
              team illustrate them. Each comic leveraged a Knights of the Round Table analogy to
              help people immediately connect with each distinct user role. Each comic strip linked
              to video clips from real users, creating a memorable and shared understanding of our
              users, and why we needed a unified concept to best meet their needs.
            </p>
          </div>
        </section>
        ...
        <section id="recommendations" className="py-6 md:py-12 lg:py-12 max-w-[580px] mx-auto">
          <h3 className="h4-bold text-purple-dark mb-6">Making the business case</h3>
          <div className="space-y-4 body-base text-neutral-dark">
            <p>
              The vision was not solely a user experience exercise. To gain executive support, I
              partnered with product leaders to connect customer outcomes to the following business
              outcomes:
            </p>
            <ul className="list-disc list-outside pl-6 space-y-2 body-base text-neutral-dark">
              ...
              <li>Reduced churn.</li>
              <li>
                Ability for customer success to focus more on strategic rather than tactical
                support.
              </li>
            </ul>
          </div>
        ...
        <section id="impact" className="py-6 md:py-12 lg:py-12 max-w-[580px] mx-auto">
          <h2 className="h3-bold text-purple-dark mb-6 md:mb-6 lg:mb-6">Impact</h2>
          <div className="space-y-4 body-base text-neutral-dark">
            <p>
              Overall, users and executives were excited about the concept. The CPO called the
              concept the “best output I've seen in my career.” However, the initiative also
              surfaced the organizational and customer challenges associated with large-scale
              product consolidation. While some customers embraced the vision, others expressed
              concern about changing established workflows.
            </p>
            <p>
              Ultimately, leadership chose a phased approach, consolidating FiscalNote and CQ into
              what became PolicyNote rather than immediately unifying all four products. Although
              the original vision was not implemented in full, the work directly influenced the
              company's product strategy and helped establish a roadmap for future consolidation
              efforts.
            </p>
          </div>
        </section>
        ...
        <div className="flex flex-col gap-16 pb-24 max-w-[784px] mx-auto">
          ...
          />
          <Quote
            text={`"I'm going to say extremely valuable and it would just... have to hit me at the right time of the year. So as soon as the legislature’s over, and then I have months before the legislature starts again, I could transition and integrate this."`}
