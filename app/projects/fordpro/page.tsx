...
export const metadata = {
  ...
  description:
    "Leading a cross-functional payments initiative at Ford Credit and Ford Pro while raising design quality, protecting team focus, and aligning stakeholders around customer transparency.",
};
