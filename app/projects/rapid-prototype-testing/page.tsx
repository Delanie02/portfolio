      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        >
          ...
          <div className="body-base text-neutral-dark space-y-4">
            <p>
              At Gartner, my team supported 18 product teams across three brands
              serving more than nine million monthly users. While user research
              was highly valued, our operating model made it difficult to
              influence product decisions at the pace teams were shipping.
            </p>
            <p>
              Research was typically conducted as large, project-based studies
              designed to answer every question at once. These studies often
              took six to eight weeks to complete, limiting teams' ability to
              iterate, validate assumptions, and learn continuously.
            </p>
            <p>As a result:</p>
            <ul className="list-disc list-outside pl-6 space-y-2 body-base text-neutral-dark">
              ...
              <li>
                Product teams hesitated to request studies because of lead
                times.
              </li>
            ...
            <p>
              I saw an opportunity to fundamentally change how research and
              product development worked together.
            </p>
          </div>
        </section>
        ...
        <section className="py-6 md:py-12 lg:py-12 max-w-[580px] mx-auto">
          ...
          <div className="body-base text-neutral-dark space-y-4">
            <p>
              As Associate Director of UX, I led the creation and rollout of a
              new rapid-testing operating model designed to embed customer
              feedback directly into product development.
            </p>
        ...
        >
          ...
          <div className="body-base text-neutral-dark space-y-4">
            <p>
              Rather than treating research as a standalone activity, I
              partnered with product leadership to redesign how teams learned
              from users. We shifted from large, multi-question studies toward a
              series of focused experiments designed to answer a small number of
              high-priority questions each sprint.
            </p>
            ...
            <ul className="list-disc list-outside pl-6 space-y-2 body-base text-neutral-dark">
              ...
              <li>
                Incorporate customer feedback into ongoing decision-making.
              </li>
            </ul>
            <p>
              The goal was not simply faster research—it was creating a
              sustainable system for evidence-based product development.
            </p>
          </div>
        </section>
        ...
        >
          ...
          <div className="space-y-4 body-base text-neutral-dark">
            <p>
              I piloted the new process with a newly formed team launching
              Capterra Services, a brand-new product line. We scoped our
              research questions so that we could provide results in a single
              sprint. We piloted three tests:
            </p>
            ...
            <p>
              Each test delivered clear insights in 10 business days or less,
              helping the team iterate quickly and confidently. Ultimately, we
              expected these designs to deliver better user experiences that
              will in turn increase vendor conversion rate.
            </p>
          </div>
        </section>
        ...
        <section className="py-6 md:py-12 lg:py-12 max-w-[580px] mx-auto">
          ...
          <div className="space-y-4 body-base text-neutral-dark">
            <p>
              I then scaled to a more established team, resulting in speeding up
              the ability for design to drive conversion and revenue impact. A
              traditional test this team ran took 7 weeks, focused on improving
              the trustworthiness of the forms that connect users to software
              advisors. While that test successfully improved conversion by 18%,
              we were looking to achieve similar results in less time. My new
              rapid testing program delivered learnings in 1.5 weeks, with a
              projected impact of $1 million in net new revenue.
            </p>
          </div>
        </section>
            ...
            images={[
              {
                ...
                subheader:
                  "How trustworthy are current-state Software Advice forms?",
              },
              {
                ...
                subheader:
                  "How trustworthy are the re-designed Software Advice forms?",
              },
            ]}
            captions={[
          ...
          <TwoImageGroup
            images={[
              ...
              },
              {
                ...
                header: "Rapid Test 2",
                subheader:
                  "How trustworthy are the re-designed Capterra forms?",
              },
            ]}
            captions={[
        ...
        <section className="py-6 md:py-12 lg:py-12 max-w-[580px] mx-auto">
          ...
          <div className="space-y-4 body-base text-neutral-dark">
            <p>
              I also scaled to a team with a different goal, demonstrating how
              the process works for a variety of teams and objectives. This team
              was focused on improving the usability and usefulness of the
              Capterra Shortlist. The last, traditional test ran on the
              Shortlist took eight weeks. After coaching the team on switching
              to a rapid testing model, the team saw an{" "}
              <b>18.6% increase in engagement</b> from the first test. While the
              second test was unsuccessful, the third test received more
              positive feedback. Each test was only 8 business days, showing how
              quickly the team could move on from a failed test and towards
              better, more successful experiences.
            </p>
          </div>
        </section>
        ...
        >
          ...
          <div className="space-y-4 body-base text-neutral-dark">
            <p>
              The rapid testing program I launched and scaled allowed us to
              speed up time to insights without sacrificing reliability or
              quality, enabling more iteration not just on the designs but on
              our understanding of our users and what they need.
            </p>
            <p>
              After launching this new way of doing research,{" "}
              <b>we tripled the number of tests run quarter-over-quarter</b>. We
              gathered more user feedback than ever before, meaning our product
              teams were better positioned than ever before to make more
              user-centered decisions. Executive leadership recognized the
